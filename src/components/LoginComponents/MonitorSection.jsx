        ...
        >
            <div className="flex flex-col md:flex-row items-center gap-12">
                ...
                >
                    ...
                    >
                        Monitor employee skill development, mentorship sessions, and learning activity completion in real-time. Gain actionable insights to help managers and HR make informed decisions for personalized growth plans.
                    </motion.p>
                    <motion.a 
