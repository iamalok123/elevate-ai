    ...
    return (
        ...
        <div className="section-container">
            ...
            >
                ...
                <span className="text-xl font-medium ml-1">IDP System</span>
                </motion.div>
                <motion.p 
                variants={fadeIn('up', 0.6)}
                className="text-gray-600 mb-6"
                >
                Personalized development plans, mentorship tracking, and skill growth all in one platform.
                </motion.p>
                <motion.div 
            ...
            >
                ...
                >
                Copyright © {new Date().getFullYear()} Elevate AI
                </motion.p>
                <motion.p 
                variants={fadeIn('left', 1.0)}
                className="text-gray-600 text-sm"
                >
                Developed by Algo Edge ❤️
                </motion.p>
            </motion.div>
            </motion.div>
        </div>
