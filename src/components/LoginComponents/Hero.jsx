...
const Hero = () => {
    return (
        ...
        <div className="w-full md:w-1/2 space-y-8">
            ...
            initial="hidden"
            whileInView="show"
            className="text-4xl md:text-5xl pr-2 lg:text-6xl font-bold leading-tight"
            >
            We boost the growth to{' '}
            <span className="text-blue-600 relative inline-block">
                Become a great Leader
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-200/60"></span>
            </span>{' '}
            Through Customised IDPs
            ...
            >
            Get the most accurate skill assessments, personalized employee development plans, mentor-led training, progress tracking, and actionable analytics — all within a single, unified platform.
            </motion.p>
