    ...
    const features = [
        {
            ...
            description: "Generate individualized development plans based on employee skills, goals, and performance data."
        },
        {
            icon: "🤝", 
            title: "Seamless Collaboration",
            description: "Connect mentors, HR, and employees to track progress, share feedback, and align growth objectives."
        }
    ];
            ...
            <div className="max-w-6xl mx-auto">
                ...
                >
                    <motion.div variants={fadeIn('right', 0.3)}>
                        ...
                        >
                            Our platform ensures employees and mentors achieve measurable progress
                        </motion.h2>
                    </motion.div>
