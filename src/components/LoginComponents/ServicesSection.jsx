    ...
    const services = [
        {
            ...
            title: "Personalized IDPs",
            description: "Generate tailored development plans for employees based on skills, goals, and performance.",
            link: "#learn-more"
        },
        {
            icon: <HiLightBulb className="w-8 h-8 text-amber-400" />,
            title: "Mentorship Tracking", 
            description: "Assign mentors, track sessions, and monitor mentee progress efficiently.",
            link: "#learn-more"
        },
        {
            icon: <FiSettings className="w-8 h-8 text-red-400" />,
            title: "Activity Management",
            description: "Manage learning activities, set goals, and track completion across the team.",
            link: "#learn-more"
        },
        {
            icon: <BiTime className="w-8 h-8 text-cyan-400" />,
            title: "Reports & Analytics",
            description: "Export detailed insights and track team performance with visual reports.",
            link: "#learn-more"
        }
    ]
        ...
        <section id="services" className="py-20 container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                >
                    ...
                    >
                        Empower Your Team with IDPs
                    </motion.h2>
                    <motion.p 
                        variants={fadeIn('up', 0.5)}
                        className="text-gray-600 text-lg mb-4 md:w-4/5"
                    >
                        Track skills, mentorship, and learning progress to maximize employee growth and engagement.
                    </motion.p>
                    <motion.div 
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-gray-600">Mentorship & tracking</span>
                        </motion.div>
                    </motion.div>
                    <motion.button 
